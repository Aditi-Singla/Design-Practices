...
//        tv5.setTypeface(tf5);
    ...
    public Boolean canSubmit() {
        ...
        if (ETentry1.getText().toString().trim().equals(ETentry3.getText().toString().trim())) {
            ETentry3.setError("Entry number already used");
            showError(ETentry3);
            return false;
        }
        if (ETentry2.getText().toString().trim().equals(ETentry3.getText().toString().trim())) {
            ETentry3.setError("Entry number already used");
            showError(ETentry3);
            return false;
        }
