...
public class FragHostelComplaints extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        String URL = "http://10.192.58.152:80/complaint_management/complaint/allcomplaints.php";
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(dateorder==-1) {
                    ...
                    dateorder = 1;
                    final RecyclerView rvComplaint = (RecyclerView)view.findViewById(R.id.viewHostelComplaints);
                    String URL = "http://10.192.58.152:80/complaint_management/complaint/sort.php";
